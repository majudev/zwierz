...
if(mysqli_query($db, $sql)){
	...
	$logbooksql = "INSERT INTO `trials_logbook`(`trialid`, `log`) values('".mysqli_real_escape_string($db, $_SESSION["login"])."', 'Kandydat usunął zadanie. (ID=".mysqli_real_escape_string($db, $_GET["id"]).")')";
