...
if (mysqli_num_rows($result) > 0){
	...
	$sql = "SELECT login,name,intent FROM appointment_registrations INNER JOIN users ON appointment_registrations.login = users.email WHERE `appointment_id`='".$row["id"]."'";
